...
const DOCUMENTS = {
  "test_001": {
    ...
    content: [
      ...
      { type: "image", url: "https://i.postimg.cc/7Zm1Qd1y/Screenshot-2026-09-15-160006.png", alt: "test_001-photo1" },
      { type: "pause", duration: 1000 },
  ...
  "test_002": {
    ...
    content: [
      ...
      { type: "pause", duration: 1000 },
      { type: "image", url: "https://i.postimg.cc/4nFdp6cM/PRI-Advanced-test-002-images-0.jpg", alt: "test_002-photo1" },
      { type: "text", value: " " },
      { type: "pause", duration: 1000 },
      { type: "image", url: "https://i.postimg.cc/Z0qn979m/PRI-Advanced-test-002-images-1.jpg", alt: "test_002-photo2" },
      { type: "text", value: " " },
      { type: "pause", duration: 1000 },
      ...
      { type: "text", value: " " },
      { type: "pause", duration: 1000 },
      { type: "image", url: "https://i.postimg.cc/vDmT1q1d/PRI-Advanced-test-002-images-4.jpg", alt: "test_002-photo5" },
      { type: "text", value: " " }
    ]
  },
