...
const DOCUMENTS = {
 ...
 "test_003": {
    ...
    content: [
      ...
      { type: "text", value: " " },
      { type: "pause", duration: 750 },
      { type: "image", url: "https://i.ibb.co/dJJybdmK/PRI-Advanced-test-003-images-0.jpg", alt: "test_003-photo1" },
      { type: "text", value: " " },
      { type: "pause", duration: 750 },
      { type: "image", url: "https://i.ibb.co/k6rNB7dp/PRI-Advanced-test-003-images-1.jpg", alt: "test_003-photo2" },
      { type: "text", value: " " },
      { type: "pause", duration: 750 },
      { type: "image", url: "https://i.ibb.co/C5FJXRy1/PRI-Advanced-test-003-images-2.jpg", alt: "test_003-photo3" },
      { type: "text", value: " " },
      { type: "pause", duration: 750 },
      { type: "image", url: "https://i.ibb.co/1cbBRkQ/PRI-Advanced-test-003-images-3.jpg", alt: "test_003-photo4" },
      { type: "text", value: " " },
      { type: "pause", duration: 1000 },
